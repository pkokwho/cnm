...
export const translations = {
  ...
  "image.noCredits": { zh: "今日积分已用完", en: "No credits left today" },
  "image.creditsReset": { zh: "每日积分将在北京时间 0:00 重置", en: "Credits reset at midnight (Beijing time)" },
  "image.dev.title": { zh: "开发者模式", en: "Developer Mode" },
  "image.dev.desc": { zh: "输入开发者密钥可解除每日积分限制", en: "Enter developer key for unlimited credits" },
